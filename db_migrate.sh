...
MIGRATION_FILE="./app/database/migrations/$1.php"
...
then
    ...
    progress 20 "migrating..."
    progress 40 "migrating..."
    progress 60 "migrating..."
    progress 80 "migrating..."
    progress 90 "migrating..."
    progress 100 "finished   "
    php $MIGRATION_FILE
else
    echo "migrate file not found. "
    exit 2
fi
